    ...
    debugMessage: function() {
        $('#chutney .chutney-message').hide().html([
            ...
            "<div class='chutney-message-content'>If Checking Influence either isn't displaying correctly, or ",
                ...
                "name will likely remain in the information that is submitted to Sunlight. Information submitted here will never ",
                "be made public and will be completely deleted once the problem is resolved.<br /><br />",
